...
|---|---|---|
| Node | Copy `node/parp.js` or publish it in your app | Adds the ARPP Link header and serves a signed manifest. |
...
public repository. Test every endpoint with the verification tools in the ARPP
...
defined in the ARPP specification. Existing `/parp` paths remain legacy-compatible.
